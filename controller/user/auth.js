...
exports.userRegistration = (req, res) => {
    ...
    bcpt.hash(req.body.password, 15).then(hashed => {
        var user_info = [req.body.u_name, req.body.reg_no, req.body.location, req.body.email, req.body.phone, req.body.role == "admin" ? 1 : req.body.role == "student" ? 3 : 2, hashed, 23, req.body.collegeID, req.body.department]
